...
var x__30756__auto__ = (((x == null))?null:x);
var m__30757__auto__ = (sablono.util.to_str[goog.typeOf(x__30756__auto__)]);
if(!((m__30757__auto__ == null))){
return m__30757__auto__.call(null,x);
} else {
var m__30757__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__30757__auto____$1 == null))){
return m__30757__auto____$1.call(null,x);
} else {
...
var x__30756__auto__ = (((x == null))?null:x);
var m__30757__auto__ = (sablono.util.to_uri[goog.typeOf(x__30756__auto__)]);
if(!((m__30757__auto__ == null))){
return m__30757__auto__.call(null,x);
} else {
var m__30757__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__30757__auto____$1 == null))){
return m__30757__auto____$1.call(null,x);
} else {
...
var len__31300__auto___31777 = arguments.length;
var i__31301__auto___31778 = (0);
while(true){
if((i__31301__auto___31778 < len__31300__auto___31777)){
args__31307__auto__.push((arguments[i__31301__auto___31778]));

var G__31779 = (i__31301__auto___31778 + (1));
i__31301__auto___31778 = G__31779;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__31308__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq31776){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31776));
});
...
var vec__31780 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__31782;
var words = seq__31781__$1;
...
var G__31783 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__31783,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__31783;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__31784_SHARP_){
if(typeof p1__31784_SHARP_ === 'string'){
return p1__31784_SHARP_;
} else {
return cljs.core.seq.call(null,p1__31784_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__30023__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1515300955010
