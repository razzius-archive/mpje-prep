...
var or__30023__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj37363 = {"detail":data};
return obj37363;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30011__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30011__auto__)){
var and__30011__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__37370 = cljs.core._EQ_;
var expr__37371 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37370.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37371))){
return ((function (pred__37370,expr__37371){
return (function (p1__37364_SHARP_){
return console.warn(p1__37364_SHARP_);
});
;})(pred__37370,expr__37371))
} else {
if(cljs.core.truth_(pred__37370.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37371))){
return ((function (pred__37370,expr__37371){
return (function (p1__37365_SHARP_){
return console.debug(p1__37365_SHARP_);
});
;})(pred__37370,expr__37371))
} else {
if(cljs.core.truth_(pred__37370.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37371))){
return ((function (pred__37370,expr__37371){
return (function (p1__37366_SHARP_){
return console.error(p1__37366_SHARP_);
});
;})(pred__37370,expr__37371))
} else {
return ((function (pred__37370,expr__37371){
return (function (p1__37367_SHARP_){
return console.log(p1__37367_SHARP_);
});
;})(pred__37370,expr__37371))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37374){
...
var eval_fn = cljs.core.get.call(null,map__37375__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37377_SHARP_);
});})(new_def))
);
...
return (function (p__37378){
var vec__37379 = p__37378;
var ky = cljs.core.nth.call(null,vec__37379,(0),null);
var v = cljs.core.nth.call(null,vec__37379,(1),null);
...
if(cljs.core.truth_((function (){var and__30011__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1515300961157
