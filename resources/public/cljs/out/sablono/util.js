...
var len__31300__auto___37319 = arguments.length;
var i__31301__auto___37320 = (0);
while(true){
if((i__31301__auto___37320 < len__31300__auto___37319)){
args__31307__auto__.push((arguments[i__31301__auto___37320]));

var G__37321 = (i__31301__auto___37320 + (1));
i__31301__auto___37320 = G__37321;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq37318){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37318));
});
...
var vec__37322 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__37324;
var words = seq__37323__$1;
...
var G__37325 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__37325,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__37325;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__37326_SHARP_){
if(typeof p1__37326_SHARP_ === 'string'){
return p1__37326_SHARP_;
} else {
return cljs.core.seq.call(null,p1__37326_SHARP_);
...
//# sourceMappingURL=util.js.map?rel=1515306580072
