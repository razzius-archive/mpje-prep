...
var x41367_41377 = mpje_prep.components.AutoFocusingButton.prototype;
x41367_41377.componentWillUpdate = ((function (x41367_41377){
...
var ident__33804__auto___41378 = om.next.ident.call(null,this__33800__auto__,om.next.props.call(null,this__33800__auto__));
var next_ident__33805__auto___41379 = om.next.ident.call(null,this__33800__auto__,om.next._next_props.call(null,next_props__33801__auto__,this__33800__auto__));
if(cljs.core.not_EQ_.call(null,ident__33804__auto___41378,next_ident__33805__auto___41379)){
var idxr__33806__auto___41380 = cljs.core.get_in.call(null,om.next.get_reconciler.call(null,this__33800__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"indexer","indexer",-1774914315)], null));
if((idxr__33806__auto___41380 == null)){
} else {
cljs.core.swap_BANG_.call(null,new cljs.core.Keyword(null,"indexes","indexes",1496475545).cljs$core$IFn$_invoke$arity$1(idxr__33806__auto___41380),((function (idxr__33806__auto___41380,ident__33804__auto___41378,next_ident__33805__auto___41379,this__33800__auto__,x41367_41377){
return (function (indexes__33807__auto__){
return cljs.core.update_in.call(null,cljs.core.update_in.call(null,indexes__33807__auto__,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),ident__33804__auto___41378], null),cljs.core.disj,this__33800__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),next_ident__33805__auto___41379], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentHashSet.EMPTY),this__33800__auto__);
});})(idxr__33806__auto___41380,ident__33804__auto___41378,next_ident__33805__auto___41379,this__33800__auto__,x41367_41377))
);
}
} else {
}
...
x41367_41377.shouldComponentUpdate = ((function (x41367_41377){
return (function (next_props__33801__auto__,next_state__33802__auto__){
var this__33800__auto__ = this;
...
var next_props__33801__auto____$2 = (function (){var G__41369 = next_props__33801__auto____$1;
if((next_props__33801__auto____$1 instanceof om.next.OmProps)){
return om.next.unwrap.call(null,G__41369);
} else {
return G__41369;
}
})();
...
x41367_41377.componentWillUnmount = ((function (x41367_41377){
return (function (){
var this__33800__auto__ = this;
...
x41367_41377.componentDidUpdate = ((function (x41367_41377){
...
x41367_41377.isMounted = ((function (x41367_41377){
return (function (){
var this__33800__auto__ = this;
...
x41367_41377.componentWillMount = ((function (x41367_41377){
return (function (){
var this__33800__auto__ = this;
...
x41367_41377.componentDidMount = ((function (x41367_41377){
return (function (){
var this$ = this;
return this$.focus();
});})(x41367_41377))
...
x41367_41377.render = ((function (x41367_41377){
return (function (){
var this__33799__auto__ = this;
var this$ = this__33799__auto__;
var _STAR_reconciler_STAR_41370 = om.next._STAR_reconciler_STAR_;
var _STAR_depth_STAR_41371 = om.next._STAR_depth_STAR_;
var _STAR_shared_STAR_41372 = om.next._STAR_shared_STAR_;
var _STAR_instrument_STAR_41373 = om.next._STAR_instrument_STAR_;
var _STAR_parent_STAR_41374 = om.next._STAR_parent_STAR_;
...
}finally {om.next._STAR_parent_STAR_ = _STAR_parent_STAR_41374;

om.next._STAR_instrument_STAR_ = _STAR_instrument_STAR_41373;

om.next._STAR_shared_STAR_ = _STAR_shared_STAR_41372;

om.next._STAR_depth_STAR_ = _STAR_depth_STAR_41371;

om.next._STAR_reconciler_STAR_ = _STAR_reconciler_STAR_41370;
}});})(x41367_41377))
;
...
var x41375_41381 = mpje_prep.components.AutoFocusingButton;


var x41376_41382 = mpje_prep.components.AutoFocusingButton.prototype;
...
var len__31490__auto___41384 = arguments.length;
var i__31491__auto___41385 = (0);
while(true){
if((i__31491__auto___41385 < len__31490__auto___41384)){
args__31497__auto__.push((arguments[i__31491__auto___41385]));

var G__41386 = (i__31491__auto___41385 + (1));
i__31491__auto___41385 = G__41386;
continue;
} else {
}
break;
...
mpje_prep.components.page_layout.cljs$lang$applyTo = (function (seq41383){
return mpje_prep.components.page_layout.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq41383));
});
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),"form",new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),cljs.core.partial.call(null,mpje_prep.control.check_question,data),new cljs.core.Keyword(null,"auto-complete","auto-complete",244958848),"off"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"question","question",-1411720117).cljs$core$IFn$_invoke$arity$1(question)], null),(cljs.core.truth_(new cljs.core.Keyword(null,"other-options","other-options",170412142).cljs$core$IFn$_invoke$arity$1(question))?(function (){var iter__31095__auto__ = (function mpje_prep$components$question_form_$_iter__41387(s__41388){
return (new cljs.core.LazySeq(null,(function (){
var s__41388__$1 = s__41388;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__41388__$1);
if(temp__5457__auto__){
var s__41388__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__41388__$2)){
var c__31093__auto__ = cljs.core.chunk_first.call(null,s__41388__$2);
var size__31094__auto__ = cljs.core.count.call(null,c__31093__auto__);
var b__41390 = cljs.core.chunk_buffer.call(null,size__31094__auto__);
if((function (){var i__41389 = (0);
while(true){
if((i__41389 < size__31094__auto__)){
var option = cljs.core._nth.call(null,c__31093__auto__,i__41389);
cljs.core.chunk_append.call(null,b__41390,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),option], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"radio",new cljs.core.Keyword(null,"name","name",1843675177),"options",new cljs.core.Keyword(null,"value","value",305978217),option], null)], null),option], null)], null));

var G__41391 = (i__41389 + (1));
i__41389 = G__41391;
continue;
} else {
return true;
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"small","small",2133478704),(cljs.core.count.call(null,mpje_prep.questions.questions) - cljs.core.count.call(null,new cljs.core.Keyword(null,"finished","finished",-1018867731).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,data))))," remaining"], null),mpje_prep.components.question_form.call(null,data,question),(cljs.core.truth_(new cljs.core.Keyword(null,"answered","answered",-1524147020).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,data)))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(cljs.core.truth_(new cljs.core.Keyword(null,"correct","correct",984806334).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,data)))?["Correct! ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(new cljs.core.Keyword(null,"note","note",1426297904).cljs$core$IFn$_invoke$arity$1(question))?["Note: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"note","note",1426297904).cljs$core$IFn$_invoke$arity$1(question))].join(''):null))].join(''):mpje_prep.components.format_correct.call(null,new cljs.core.Keyword(null,"answer","answer",-742633163).cljs$core$IFn$_invoke$arity$1(question))),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button#next","button#next",-1535336029),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),cljs.core.partial.call(null,mpje_prep.control.next_question,data)], null),"Next Question"], null)], null)], null):null)], null);
})()
))));
});

//# sourceMappingURL=components.js.map?rel=1518815963490
