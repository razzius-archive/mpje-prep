...
var or__30213__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj32010 = {"detail":data};
return obj32010;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30201__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30201__auto__)){
var and__30201__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__32017 = cljs.core._EQ_;
var expr__32018 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__32017.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__32018))){
return ((function (pred__32017,expr__32018){
return (function (p1__32011_SHARP_){
return console.warn(p1__32011_SHARP_);
});
;})(pred__32017,expr__32018))
} else {
if(cljs.core.truth_(pred__32017.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__32018))){
return ((function (pred__32017,expr__32018){
return (function (p1__32012_SHARP_){
return console.debug(p1__32012_SHARP_);
});
;})(pred__32017,expr__32018))
} else {
if(cljs.core.truth_(pred__32017.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__32018))){
return ((function (pred__32017,expr__32018){
return (function (p1__32013_SHARP_){
return console.error(p1__32013_SHARP_);
});
;})(pred__32017,expr__32018))
} else {
return ((function (pred__32017,expr__32018){
return (function (p1__32014_SHARP_){
return console.log(p1__32014_SHARP_);
});
;})(pred__32017,expr__32018))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32021){
...
var eval_fn = cljs.core.get.call(null,map__32022__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__32024_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__32026,(0),null);
...
if(cljs.core.truth_((function (){var and__30201__auto__ = figwheel.client.utils.feature_QMARK_.call(null,localStorage,"getItem");
if(cljs.core.truth_(and__30201__auto__)){
...
//# sourceMappingURL=utils.js.map?rel=1518813252238
